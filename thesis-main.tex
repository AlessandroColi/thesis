...
\end{tikzpicture}\begin{tikzpicture}
    ...
    \addplot[fill=red] coordinates{({\shortstack{Windows\\Environment}},0.430)({\shortstack{Linux\\Environment}},0.120)};
    \legend{JVM, JS, NATIVE}
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \addplot[fill=red] coordinates {(0.278,{locale\\Windows}) (0.246,{locale\\Linux}) (1.363,{remoto\\Windows}) (0.390,{remoto\\Linux})};

        \legend{JVM min, JVM max, JS min, JS max, NATIVE min, NATIVE max}
        \end{axis}
    \end{tikzpicture}
    \caption{range di tempi di esecuzione nelle diverse condizioni: massimo e minimo registarti durante la fase di raccolta dati}
    \label{fig:range di tempi di esecuzione}
\end{figure}

%TODO: rivedi con i dati veri
