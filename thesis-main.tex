...
\begin{center}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            reverse legend,
            yticklabel style={align=left, text width=8em},
            every node near coord/.append style={font=\tiny, anchor=west}
        ]

        \addplot[fill=green] coordinates {(8.200,{locale\\Windows})[min] (4.633,{locale\\Linux})[min] (7.593,{remoto\\Windows})[min] (4.853,{remoto\\Linux})[min]};
        \addplot[fill=green,draw=none] coordinates {(9.324,{locale\\Windows})[max] (4.986,{locale\\Linux})[max] (9.972,{remoto\\Windows})[max] (5.559,{remoto\\Linux})[max]};
        
        \addplot[fill=blue] coordinates {(1.865,{locale\\Windows})[min] (0.920,{locale\\Linux})[min] (1.590,{remoto\\Windows})[min] (1.076,{remoto\\Linux})[min]};
        \addplot[fill=blue,draw=none] coordinates {(2.335,{locale\\Windows})[max] (1.108,{locale\\Linux})[max] (2.039,{remoto\\Windows})[max] (1.183,{remoto\\Linux})[max]};
        
        \addplot[fill=red] coordinates {(0.235,{locale\\Windows})[min] (0.190,{locale\\Linux})[min] (0.430,{remoto\\Windows})[min] (0.307,{remoto\\Linux})[min]};
        \addplot[fill=red,draw=none] coordinates {(0.278,{locale\\Windows})[max] (0.246,{locale\\Linux})[max] (1.363,{remoto\\Windows})[max] (0.390,{remoto\\Linux})[max]};
