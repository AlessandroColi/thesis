...
Per quanto riguarda lo sviluppo del modulo JavaScript, è stata utilizzata la libreria MQTT.JS, che offre un'implementazione di un client \ac{MQTT} in JavaScript. 
...
i seguenti metodi, fondamentali per il funzionamento del client \ac{MQTT}:
\begin{itemize}
    \item \texttt{connect}: Questo metodo consente di connettere il client al broker, permettendo di specificare tutte le opzioni della connessione, 
