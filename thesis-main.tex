...
\texttt{gradlew allTest --parallel --profile} in differenti condizioni operative, garantendo un confronto equo e accurato.
...
localmente tramite Mosquitto, configurato per richiedere autenticazione, offrendo così un contesto controllato e stabile per le misurazioni. Nel secondo caso, è stato utilizzato 
il broker remoto \texttt{test.mosquitto.org}, che non richiede autenticazione, simulando un ambiente più realistico e variabile. Questa doppia configurazione ha permesso di 
valutare le prestazioni del sistema in scenari sia controllati che più dinamici, fornendo una visione completa e approfondita delle capacità e dei limiti del progetto 
