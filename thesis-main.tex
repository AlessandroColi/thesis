...
In particolare, è stato necessario aggiornare il file \texttt{build.gradle} per trasformarlo da file di configurazione adatto a un progetto autonomo a uno adatto ad un 
...
\begin{acknowledgements}
    Al termine di questo elaborato, mi è d'obbligo ringraziare tutte le persone che mi sono state vicine e mi hanno supportato nella stesura della tesi e che mi sono state vicine 
    ...
    in ogni passo della realizzazzione dell'elaborato, dalla scelta dell'argomento alla stasura della tesi ma in particolare durante lo svolgimento del progetto.\\
    Ringrazio dal profondo del mio cuore i miei genitori, che durante questi impegnativi anni di università mi hanno supportato nonostante le difficoltà.
    Mi hanno sepre spinto a dare il meglio di me, permettendomi di raggiungere risultati a cui mai avrei potuto ambire senza il loro sostegno durante i momenti di crisi.\\
    ...
    Grazie ai miei amici di sempre, in particolare Ale, per essermi stati vicini anche se io ero lontano, condividendo con me gioie e dolori di una vita.
    Grazie per avermi ascoltato e per avermi aiutato a distogliere la mente dallo studio e creando ricordi indelebili, che si vanno a sommare ai precedenti.\\
    ...
    Ma soptrattutto grazie per i molteplici momenti felici vissuti insieme, che mi permetteranno di ricordare con grande gioia questi anni a Cesena.\\
    ...
    importanti nella vita oltre all'università e per avermi dato gradi possibilità di crescita personale oltre che legami che porterò sempre con me.
