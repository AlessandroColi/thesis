...
\begin{itemize}
    ...
    Nel caso ci sia ppoggi alla \ac{JVM} vi è una differenza di 3.153 secondi, nel caso di \ac{JS} la discrepanza è di 730 millisecondi 
    mentre in caso di esecuzione nativa di solamente 75ms. Questo mostra come Linux sia più efficiente di Windows nella gestione delle risorse; 
    la differenza sarebbe probabilmente meno notevole in caso di esecuzione su un dispositivo con maggiori capacità hardware.
