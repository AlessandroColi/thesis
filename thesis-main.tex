...
Nella tesi vengono esposte ndettagliatamente le diverse fasi di progettazzione e di sviluppo del progetto, partendo dall'analisi dei requisiti fino alla validazione.
Successivamente viene il processo d'integrazione del progetto sviluppato all'interno di PulvReAKt.\\
