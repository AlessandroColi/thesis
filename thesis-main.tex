...
\begin{abstract}	
    ...
    In particolare nell'ambito di questa tesi il progetto è stato anche integrato nel più ampio contesto del progetto PulvReAKt, all'interno del quale ha il compito di gestire 
    le comunicazioni remote tra le entità del progetto dislocate in siti differenti.
...
sono stati variati sia il sistema operativo sottostante sia il luogo di hosting del broker \ac{MQTT}.
