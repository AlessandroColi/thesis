...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        caldo di messaggi che può essere consumato dal runtime. Può riuscire o fallire con un \texttt{ProtocolError}. Fallisce se le entità \texttt{from} e \texttt{to} non sono 
        registrate nel protocollo tramite il metodo \texttt{setupChannel}.
    \end{itemize}
