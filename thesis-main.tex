...
\begin{axis}[
    ...
    ymax=7,
    ylabel={Time (s)},
    symbolic x coords={Windows Enviroment, Linux Enviroment},
    xtick=data,
    bar width=0.5cm,
...
\addplot[fill=green] coordinates{(Windows Enviroment,6.327) (Linux Enviroment,5.464)};
\addplot[fill=blue] coordinates{(Windows Enviroment,5.614) (Linux Enviroment,5.553)};
\addplot[fill=red] coordinates{(Windows Enviroment,2.133) (Linux Enviroment,0.311)};
...
\addplot[fill=green] coordinates{(Windows Enviroment,6.154)(Linux Enviroment,5.876)};
\addplot[fill=blue] coordinates{(Windows Enviroment,6.189)(Linux Enviroment,6.273)};
\addplot[fill=red] coordinates{(Windows Enviroment,2.542)(Linux Enviroment,1.739)};
\legend{JVM, JS, NATIVE}
